    ...
    for (let i = 0; i < sessionStorage.length; i++) {
      ...
      if (key) {
        try {
          ...
          storageData.sessionStorage[key] = sessionValue ? JSON.parse(sessionValue) : null;
        } catch (e) {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: "12px", color: "#4a5568" }}>
        <p>
          <strong>Local Storage Keys:</strong> {Object.keys(debugInfo.localStorage || {}).join(", ") || "None"}
        </p>
        <p>
          <strong>Session Storage Keys:</strong> {Object.keys(debugInfo.sessionStorage || {}).join(", ") || "None"}
        </p>
        <p>
          <strong>Global Variables:</strong> {Object.keys(debugInfo.globalVariables || {}).join(", ") || "None"}
        </p>
      </div>
