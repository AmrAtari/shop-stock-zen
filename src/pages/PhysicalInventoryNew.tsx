...
const PhysicalInventoryNew: React.FC = () => {
  ...
  const handleSubmit = async (data: PhysicalInventoryFormData, startCounting: boolean) => {
    // FINAL CLEAN ATTEMPT: Use 'DRAFT'. If this fails, the exact status must be found in the SQL schema.
    const status = 'DRAFT'; 
    ...
    try {
        ...
        // Final explicit request for the SQL schema if the error persists.
