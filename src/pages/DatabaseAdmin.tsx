    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Run custom SQL commands directly against the database.
        </p>
      </CardHeader>
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">
                    View the first 50 rows of essential database tables.
                </p>
            </CardHeader>
            <CardContent className="space-y-4">
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    {tableData.length > 0 ? (
                                        ...
                                        <TableRow>
                                            <TableCell colSpan={columns.length || 1} className="text-center italic text-muted-foreground py-10">
        ...
        <div className="p-8 max-w-6xl mx-auto space-y-6">
            ...
            <Card>
                ...
                <CardContent className="text-sm space-y-3">
                    <p>
                        For the **SQL Editor** tab to function, you **must** create the **`execute_raw_sql`** PostgreSQL function in your Supabase project's SQL Editor. Run the following code in your Supabase SQL editor:
                    </p>
