            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea {...register("billingAddress")} placeholder="Billing address" rows={3} disabled={sameBillingAddress} />
                </div>
                <div className="space-y-2">
                  ...
                  <Textarea {...register("shippingAddress")} placeholder="Shipping address" rows={3} disabled={sameShippingAddress} />
                </div>
              </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input type="number" min="0" max="100" step="0.01" {...register("taxPercent", { valueAsNumber: true })} />
              </div>
              <div className="space-y-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea {...register("specialInstructions")} placeholder="Any special requirements or notes..." rows={4} />
            </div>
          </CardContent>
        </Card>
